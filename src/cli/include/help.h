...
Examples:
  most used:
  ./cribbage -h "AH 2H 3H 4H 5H 6H" --dealer 1
  ./cribbage -h "AH 2H 3H 4H 5H 6H" --dealer N -c AH --top-discards 3
  ./cribbage -h "AH 2H 3H 4H 5H 6H" --dealer 0 -d "AH 2H"

  other:
  ./cribbage -h "AH 2H 3H 4H 5H 6H" -c "7H" -d "AH 2H" -s "median combined"
  ./cribbage -h "AH 2H 3H 4H 5H 6H" -c "7H" -d "AH 2H" -s "mean hand" -t "stat_vs_stat"
)";
}
